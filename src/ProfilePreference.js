...
const ProfilePrefernce = () => {
//   const [activeTab, setActiveTab] = useState('profile');
   const [activeTab, setActiveTab] = useState('prefernce');
    ...
    <>
      <style>
        {`
          ...
          .sidebar-brand h4 {
            background: linear-gradient(135deg, #7dd3fc 0%, #00ff88 100%);
            font-weight: 600;
            margin: 0;
            font-size: 1.5rem;
          }
          ...
          .update-btn {
            background: linear-gradient(135deg, #00ff88 0%, #7dd3fc 100%);
            border: none;
            color: #000000;
            padding: 12px 30px;
            border-radius: 8px;
                ...
                <div className="profile-section">
                  ...
                  <div onSubmit={handleSubmit}>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="form-group">
                          <div className="form-label">System Language</div>
                          <input
                            type="text"
                            name="fullname"
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          <div className="form-label">General Language</div>
                          <input
                            type="email"
                            name="email"
                            className="form-input"
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          <div className="form-label">Formality Level</div>
                          <div className="password-input-container">
                            <input
...
export default ProfilePrefernce;